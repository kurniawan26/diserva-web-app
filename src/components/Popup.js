...
import imgPopup1 from "../img/nat-8.jpg";
import imgPopup2 from "../img/nat-9.jpg";
    ...
    <div className="popup" id="popup">
      <div className="popup__content">
        <div className="popup__left">
          <img src={imgPopup1} alt="Tour" className="popup__img" />
          <img src={imgPopup2} alt="Tour" className="popup__img" />
        </div>
